...
function chengeStyleFull(){
	var iContentW = $(window).width() - (DWZ.ui.sbar ? $("#sidebar").width() + 10 : 34) - 5;
	var iContentH = $(window).height() - $("#header").height() - 34;
	
	//var iContentH = $(window).height() - $("#header").height() - 240;
	//var iContentH = 466;
	...
	//$(".accordionContent").height(628);
	$(".accordionContent").height(iContentH-110);
	var iframesArray = document.getElementsByTagName("iframe");
	var count = iframesArray.length;
	for(var i = 0; i < count; i++){
		var temp = iframesArray[i];
		temp.height = iContentH-35;
	}
}
function chengeStyle(){
	var iContentW = $(window).width() - (DWZ.ui.sbar ? $("#sidebar").width() + 10 : 34) - 5;
	var iContentH = $(window).height() - $("#header").height() - 34-260;
...
function linkChartToPage(tabid,url,title){
	alert("dddddd");
	navTab.openTab(tabid, url,{title:title, fresh:"false", external:"true"});
}
