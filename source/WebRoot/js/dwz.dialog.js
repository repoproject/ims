...
(function($){
	$.pdialog = {
		_op:{height:300, width:1051, minH:40, minW:50, total:20, max:false, mask:false, resizable:true, drawable:true, maxable:true,minable:true,fresh:true},
		_current:null,
		_zIndex:45,
		getCurrent:function(){
...
//					$.pdialog.switchDialog(dialog);
		...
		_init:function(dialog, options) {
			...
			var dataId = dialog.data("id");
			if("changepassword" == dataId){
				...
				var iTop = $(window).height()-dialog.height()-28;
				dialog.css({
					//left: 4,
					//top: 555
					left: 4,
