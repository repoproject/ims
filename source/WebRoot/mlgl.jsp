...
<iframe width="100%" height="100%" frameborder="0" id="frm" name="frm" scrolling="no" onload="adjustheight()" src="/zxyx/ShowReport.wx?PAGEID=mlglpage"></iframe>
</body>
</html>