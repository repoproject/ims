...
import com.wabacus.system.component.container.panel.Panel;

public class PanelBean extends AbsContainerConfigBean
{

    public PanelBean(AbsContainerConfigBean parentContainer,String tagname)
    {
    ...
    {
        return new Panel(parentContainer,this,rrequest);
    }
