...
public class WabacusDataImportException extends RuntimeException
{
    private static final long serialVersionUID=3225488091392810564L;
    
    private Throwable mRootCause=null;

    public WabacusDataImportException()
    {}

    public WabacusDataImportException(String message)
    {
        super(message);

    }

    public WabacusDataImportException(Throwable t)
    {
        super(t);
        mRootCause=t;
    }

    public WabacusDataImportException(String mess,Throwable t)
    {
        super(mess,t);
        mRootCause=t;
    }
