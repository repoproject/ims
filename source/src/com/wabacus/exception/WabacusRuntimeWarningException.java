...
public class WabacusRuntimeWarningException extends RuntimeException
{
    private static final long serialVersionUID=3504098228835387330L;
    
    private Throwable mRootCause=null;

    public WabacusRuntimeWarningException()
    {}

    public WabacusRuntimeWarningException(String message)
    {
        super(message);

    }

    public WabacusRuntimeWarningException(Throwable t)
    {
        super(t);
        mRootCause=t;
    }

    public WabacusRuntimeWarningException(String mess,Throwable t)
    {
        super(mess,t);
        mRootCause=t;
    }
